...
export function MobileProjectConsult({ project, onBack, onOpr, onGallery, onDocuments, onStartVisit, onViewPV }) {
  ...
  return (
    <div style={{ minHeight: "100%", background: BG, paddingBottom: 40 }}>
      ...
      {/* Consulter */}
      <div style={{ fontSize: 12, fontWeight: 700, color: TX3, textTransform: "uppercase", letterSpacing: "0.05em", padding: "0 8px 10px" }}>Consulter</div>
      <div style={{ margin: "0 8px", background: WH, border: "1px solid #EFEDEB", borderRadius: 14, overflow: "hidden" }}>
      ...
      {/* Note lecture seule */}
      <div style={{ margin: "18px 8px 0", display: "flex", alignItems: "center", gap: 9, background: "#F7F5F3", borderRadius: 11, padding: "11px 13px" }}>
